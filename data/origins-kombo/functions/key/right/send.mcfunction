#> origins-kombo:key/right/send
#
#   > `key.right` keybind
#
#@within function *:key/right/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.right"
