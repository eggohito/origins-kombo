#> origins-kombo:key/left/send
#
#   > `key.left` keybind
#
#@within function *:key/left/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.left"
