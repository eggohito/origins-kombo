...
#
#$within origins/power origins-kombo:key/load_toolbar_activator
...
data modify storage rx:io playerdb.player.data.origins-kombo.main append value "key.load_toolbar_activator"
