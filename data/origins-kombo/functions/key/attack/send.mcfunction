#> origins-kombo:key/attack/send
#
#   > `key.attack` keybind
#
#@within function *:key/attack/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.attack"
