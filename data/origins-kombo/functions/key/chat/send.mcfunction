#> origins-kombo:key/chat/send
#
#   > `key.chat` keybind
#
#@within function *:key/chat/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.chat"
