#> origins-kombo:key/back/send
#
#   > `key.back` keybind
#
#@within function *:key/back/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.back"
