#> origins-kombo:key/drop/send
#
#   > `key.drop` keybind
#
#@within function *:key/drop/check
...
data modify storage rx:io playerdb.player.data.origins-kombo.input.current append value "key.drop"
